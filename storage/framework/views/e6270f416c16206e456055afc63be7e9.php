...
<?php endif; ?>
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox" class="rounded border-gray-300 text-rose-600 shadow-sm focus:ring-indigo-500" name="remember">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\ilmishop\resources\views/auth/login.blade.php ENDPATH**/ ?>