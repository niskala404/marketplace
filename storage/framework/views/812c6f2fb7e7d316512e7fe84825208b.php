...
<div class="bg-white border rounded-2xl p-5">
  <form method="POST" action="<?php echo e(route('admin.banners.store')); ?>" enctype="multipart/form-data" class="space-y-4">
    <?php echo csrf_field(); ?>
    ...
    <div class="flex gap-2">
      <a href="<?php echo e(route('admin.banners.index')); ?>" class="px-4 py-3 rounded-xl border">Batal</a>
...
<?php echo $__env->make('layouts.market', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ilmishop\resources\views/admin/banners/create.blade.php ENDPATH**/ ?>