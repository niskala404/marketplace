...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware('role:admin')->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::post('/flash-sale-items/{item}/toggle', [FlashSaleController::class, 'toggleItem'])
            ->name('flash-sales.items.toggle');

        Route::delete('/flash-sale-items/{item}', [FlashSaleController::class, 'deleteItem'])
